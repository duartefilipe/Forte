...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Apis
                <small>Cadastrar Nova Api</small>
            </h1>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box box-default collapsed-box">
                        <div class="box-header with-border" style="background: #008595">
                            <h3 class="box-title btn btn-box-tool button" data-widget="collapse">
                                <span style="color: white;">   <!--<img src="resources/Images/logo.png" class="img-responsive"/> -->
                                    <b>Zabbix</b>
                                </span>
                            </h3>
                            ...
                            <form action="CadZabbix" method="post">
                                <div class="row">
                                    ...
                                    <%--<div class="col-md-3">--%>
                                        <%--<div class="form-group">--%>
                                            <%--<label>Grupo</label>--%>
                                            <%--<select name="grupoid" class="form-control select2" style="width: 100%;">--%>
                                                <%--<option></option>--%>
                                ...
                                <input type="hidden" class="form-control" value="1" name="useip">
                                <input type="hidden" class="form-control" value="1" name="main">
