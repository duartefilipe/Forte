...
public boolean enviarEmail(String to, String subject, String message){
        ...
        mailSenha = "eumesmoporra22";

        props.put("mail.transport.protocol", "smtp"); //define protocolo de envio
        props.put("mail.smtp.starttls.enable", "true");
        props.put("mail.smtp.host", mailSMTPServer); //server smtp do gmail
        props.put("mail.smtp.auth", "true"); //ativa autenticacao
        props.put("mail.smtp.user", "filipe.duarte@fortesecurity.com.br"); //conta que ta enviando o email
        ...
        auth = new SimpleAuth("filipe.duarte@fortesecurity.com.br",mailSenha);
        ...
        try{
            ...
            msg.setFrom(new InternetAddress("filipe.duarte@fortesecurity.com.br"));
        ...
        try{
            ...
            tr.connect(mailSMTPServer, "filipe.duarte@fortesecurity.com.br", mailSenha);
            msg.saveChanges();
