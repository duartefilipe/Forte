...
public class UserServiceImpl implements IUserService {
	...
	public boolean addUser(User user){
		...
		UserCreateRequest.UserCreateParams params = createRequest.getParams();
...
//			}
	...
	public boolean deleteUser(User user){
		...
		if(user!=null&&user.getUserid()!=null&&!"".equals(user.getUserid())){
			...
			delete.getParams().add(String.valueOf(user));
				...
				if(array!=null&&array.length()>0){
					for(int i=0;i<array.length();i++){
						...
						if(userjson.has("passwd")){
							user.setPassword(userjson.getString("passwd"));
						}
...
//			}
	...
	public boolean updateUser(User user){
		...
		if(groups!=null&&groups.size()>0){
			...
			UserUpdateRequest.UserUpdateParams params = updateRequest.getParams();
			if(grouplist!=null&&grouplist.size()>0){
