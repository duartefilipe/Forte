...
import br.forte.controller.Apis.Zabbix.api.service.IActionService;
...
//			}
	...
	public boolean addAction(Action action){
		...
		ActionCreateRequest.ActionCreateParams params = create.getParams();
		if(action!=null){
...
//									actionOperation.setOpcommand(opcommand);
	...
	public boolean updateAction(Action action) {
		...
		ActionUpdateRequest.ActionUpdateParams params = update.getParams();
		if(action!=null){
			List<ActionOperation> actionOperations = action.getOperations();
